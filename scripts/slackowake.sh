...
expect -c "spawn ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@10.20.30.40; expect -re \".*assword: \"; send lounge\\r; expect -re \".*~\# \"; send \"killall midori\\r\"; send \"sleep 0.5\\r\"; send \"killall midori\\r\"; send \"sleep 0.5\\r\"; send \"killall midori\\r\"; send \"logout\\r\"; expect eof"
